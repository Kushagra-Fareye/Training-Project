...
class TodoControllerTest {
    ...
    void getTodo() {
        ...
        Todo fetchedTodo = restTemplate.getForObject("http://localhost:8081/todo?todoId=" + createdTodo.getId(),
                Todo.class);
    ...
    void updateTodo() {
        ...
        Todo updatedTodo = restTemplate.getForObject("http://localhost:8081/todo?todoId=" + createdTodo.getId(),
                Todo.class);
